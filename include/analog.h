...
* @return void
*/
void cppp_getAnalogValues(uint16_t *analog11, uint16_t *analog12, uint16_t *analog13, uint16_t *analog16, uint16_t *analog17,  uint16_t *analog19, uint16_t *analog23);
