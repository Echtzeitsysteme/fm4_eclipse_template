...
void cppp_drawPixel(int16_t x, int16_t y, uint16_t color) {
	...
	// trace_printf("113 cppp_drawPixel  \n");
	//  LCD_CS = 0u;
	// LCD_CD = 0u;
	cppp_write8(0x2C);
	//  LCD_CD = 1u;
...
void cppp_drawCircleHelper(int x0, int y0, int r, char cornername,
		unsigned int color) {
	int f = 1 - r;
	int ddF_x = 1;
	int ddF_y = -2 * r;
...
void cppp_fillCircleHelper(int16_t x0, int16_t y0, int16_t r,
...
void cppp_drawLine(int16_t x0, int16_t y0, int16_t x1, int16_t y1,
		uint16_t color) {
...
void cppp_drawTriangle(int16_t x0, int16_t y0, int16_t x1, int16_t y1,
...
void cppp_fillTriangle(int16_t x0, int16_t y0, int16_t x1, int16_t y1,
		int16_t x2, int16_t y2, uint16_t color) {
